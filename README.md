...
```javascript
import incrwmean from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-wmean@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-wmean/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-incr-wmean/actions/workflows/test.yml?query=branch:v0.2.2
